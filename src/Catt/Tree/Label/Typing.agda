...
TySArr-proj₂ : Typing-STy ΓS As → Typing-STy ΓS (sty-base As)
...
unrestrict-label-Ty : {L : Label-WT (COT-to-MT ΓS) S } → Typing-Label ΓS L → Typing-STy ΓS (lty L) → .⦃ _ : NonZero (sty-dim (lty L)) ⦄ → Typing-Label ΓS (unrestrict-label L ,, sty-base (lty L))
