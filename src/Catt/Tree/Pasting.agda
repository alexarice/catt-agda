...
extend-tree zero Sing⊤ = Join tt (Sing tt) (Sing tt)
...
tree-to-pd : (T : Tree Xr l m) → tree-to-ctx T ⊢pd
tree-to-pd (Sing _) = Finish Base
tree-to-pd (Join _ S T) = connect-susp-pd (tree-to-pd S) (tree-to-pd T)

tree-to-pd-focus-tm : (T : Tree Xr l m) → pd-focus-tm (tree-to-pd T) ≃tm tree-last-var T
tree-to-pd-focus-tm (Sing _) = refl≃tm
tree-to-pd-focus-tm (Join _ S T) = begin
