...
data ctx-dim : Ctx n → ℕ → Set
data ty-dim : ctx-dim Γ d → Ty (ctxLength Γ) → ℕ → Set
data tm-dim : ctx-dim Γ d → Tm (ctxLength Γ) → ℕ → Set
data sub-dim : ctx-dim Γ d → ctx-dim Δ d′ → Sub (ctxLength Γ) (ctxLength Δ) → Set
