...
module Deprecated.Typing.Insertion.Support (ops : Op)
                                     (rules : RuleSet)
                                     (tame : Tame ops rules)
...
open import Deprecated.Tree.Insertion.Support
...
open import Deprecated.Typing.Structured.Support ops rules tame supp-cond
