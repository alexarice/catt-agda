...
sub-from-connect-Ty : Typing-Sub Γ Υ σ → Typing-Sub Δ Υ τ → (t [ σ ]tm ≈[ Υ ]tm Var (fromℕ _) [ τ ]tm) → Typing-Sub (connect Γ t Δ) Υ (sub-from-connect σ τ)
...
sub-between-connects-Ty {Δ = Δ} {σ = σ} {Θ = Θ} {τ = τ} {s = s} {t = t} σty τty sty p q
